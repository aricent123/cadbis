...
public class RadiusClient
{
    ...
    private void generateMessageAuthenticator(RadiusPacket request)
    {
        ...
        System.arraycopy(MD5.hmac_md5(format.packPacket(request), sharedSecret.getBytes()), 0, hash, 0, 16);
    }
    ...
    private boolean verifyMessageAuthenticator(RadiusRequest request, RadiusResponse reply, boolean required)
    {
        ...
        System.arraycopy(MD5.hmac_md5(format.packPacket(reply), sharedSecret.getBytes()), 0, hash, 0, 16);
