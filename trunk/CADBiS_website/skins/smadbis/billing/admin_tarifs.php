...
<table width=100%>
     ...
     <!-- <tr><td width=50% class=tbl1>
     <table width=100% class=tbl2 style="cursor:hand;" cellspacing=0 cellpadding=0 onclick="document.location.href='?p=smadbis&act=tarifs&action=denied_urls';">
      <td height=100px width=30% align=center bgcolor=#F0F6F8><img src="<? OUT(SK_DIR) ?>/img/bill_delete_tarif.gif"></td>
      <td bgcolor=#F0F6F8><div align=center><b><a href="?p=smadbis&act=tarifs&action=denied_urls">Запрещённые URL</a></b></div><br>
              Управление запрещёнными URL
      </td>
      </table>
     </td></tr> -->
</table>
