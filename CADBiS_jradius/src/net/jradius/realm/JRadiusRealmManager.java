...
public class JRadiusRealmManager
{
    ...
    public void setRealmFactory(Serializable name, RealmFactory factory)
    {
    ...
    {
        RealmFactory factory = (RealmFactory)factories.get(name);
        if (factory == null && name != null) factory = (RealmFactory)factories.get(null);
        return factory;
    }
    ...
    public JRadiusRealm getRealm(String realm) throws RadiusException
    {
    		...
    		{
    			RealmFactory factory = (RealmFactory)i.next();
